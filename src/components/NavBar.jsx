...
//                     <div className="flex space-x-4 border border-black px-3 py-2 rounded-full bg-blue-600">
//                         <NavLink to="/" className="flex gap-1 text-white text-lg font-semibold" activeClassName="text-yellow-400"><MdHomeFilled className='mt-1 ' />Home</NavLink>
//                     </div>
//                 </div>
//             </div>
//         </nav>
